...
export default function PatientDetailPage() {
  ...
  // Dummy data for prescriptions and reports for this specific patient
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog>
          ...
          <DialogContent className="sm:max-w-[700px] lg:max-w-[800px] max-h-[90vh] overflow-y-auto">
            ...
            <PrescriptionForm /> {/* You might want to pre-fill patientId here */}
          </DialogContent>
        </Dialog>
      </div>
      <Card>
        <CardHeader>
          ...
          <CardDescription>All prescriptions issued to {patient.name}.</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>All medical reports and documents for {patient.name}.</CardDescription>
        </CardHeader>
        <CardContent>
